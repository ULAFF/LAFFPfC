...
//    if ( OperInfo[ i ][ OPERAND_TYPE ] == '0' ) c = "\\"+c;
  ...
  str += "\\renewcommand{\\operation}{\\operation}\n\n";
   ...
   if ( OperInfo[ i ][ OPERAND_IO ] == IO_INOUT ){
     ...
     case '4':
	     ...
	     c = MChoices[ OperInfo[ i ][ OPERAND_NAME ] ];           
             ...
             str += indent+"\\left(\\begin{array}{c I c}\n";
	     str += indent+"   "+c+"_{TL} \& "+c+"_{TR} \\\\ \\whline \n";
             str += indent+"   "+c+"_{BL} \& "+c+"_{BR}\n";
   	     str += indent+"\\end{array}\\right) =\n";
             str += indent+"\\left(\\begin{array}{c I c}\n";
	     str += indent+"   \\widehat "+c+"_{TL} & \\widehat "+c+"_{TR} \\\\ \\whline\n";
	 ...
	 str += indent+"\\left(\\begin{array}{c I c}\n";
         ...
         str += " & "+c+"_R";
         if ( OperInfo[ i ][ OPERAND_TYPE ] == TYPE_VECTOR ) str += "^T";
         str += "\n"+indent+"\\end{array}\\right)  = \n";
	 str += indent+"\\left(\\begin{array}{c I c}\n";
         str += indent+"   \\widehat "+c+"_L";
         if ( OperInfo[ i ][ OPERAND_TYPE ] == TYPE_VECTOR ) str += "^T";
         str += indent+" & \\widehat "+c+"_R";
         if ( OperInfo[ i ][ OPERAND_TYPE ] == TYPE_VECTOR ) str += "^T";
         str += "\n"+indent+"\\end{array}\\right)\n";
     ...
     case '8': 
	 c = LAllChoices[ OperInfo[ i ][ OPERAND_TYPE ] ][ OperInfo[ i ][ OPERAND_NAME ] ];           
	 str += indent+"\\left(\\begin{array}{c}\n";
         str += indent+"   "+c+"_T \\\\ \\whline\n";
         str += indent+"   "+c+"_B \n"
         str += indent+"\\end{array}\\right)  = \n";
	 str += indent+"\\left(\\begin{array}{c}\n";
         str += indent+"   \\widehat "+c+"_T \\\\ \\whline \n";
	 ...
	 */
     ...
     case '4':
	     ...
	     str += indent+"   "+c+"_{TL} \& "+c+"_{TR} \\\\ \\whline \n";
   	     ...
   	     str += indent+"\\end{array}\\right) \n";
             ...
             if ( DirChoicesAfterShort[ OperInfo[ i ][ 2 ] ] == 'BR' ){
		 str +=  indent+"\\left(\\begin{array}{c I c | c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\whline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \\hline \n";
		 str +=  indent+"   "+c+"_{20} & "+v+"_{21} & "+c+"_{22}\n";
		 str +=  indent+"\\end{array}\\right) \n";
                 str +=  indent+"$\n";
             }
             if ( DirChoicesAfterShort[ OperInfo[ i ][ 2 ] ] == 'TL' ){
		 str +=  indent+"\\left(\\begin{array}{c | c I c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\hline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \\whline \n";
		 str +=  indent+"   "+c+"_{20} & "+v+"_{21} & "+c+"_{22}\n";
		 str +=  indent+"\\end{array}\\right) \n";
                 str +=  indent+"$\n";
             }
             if ( DirChoicesAfterShort[ OperInfo[ i ][ 2 ] ] == 'TR' ){
		 str +=  indent+"\\left(\\begin{array}{c I c | c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\hline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \\whline \n";
		 str +=  indent+"   "+c+"_{20} & "+v+"_{21} & "+c+"_{22}\n";
		 str +=  indent+"\\end{array}\\right) \n";
             ...
             if ( DirChoicesAfterShort[ OperInfo[ i ][ 2 ] ] == 'BL' ){
		 str +=  indent+"\\left(\\begin{array}{c | c I c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\whline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \\hline \n";
		 str +=  indent+"   "+c+"_{20} & "+v+"_{21} & "+c+"_{22}\n";
     ...
     case '6': 
          ...
          if ( OperInfo[ i ][ OPERAND_TYPE ] != '0' ){
              ...
              str += "\n"+indent+"\\end{array}\\right)\n";
              str += indent+"\\rightarrow\n";
	      if ( DirChoicesAfterShort[ OperInfo[ i ][ 2 ] ] == 'R' ){
		  str += indent+"\\left(\\begin{array}{c I c | c}\n";
	      }
	      if ( DirChoicesAfterShort[ OperInfo[ i ][ 2 ] ] == 'L' ){
		  str += indent+"\\left(\\begin{array}{c | c I c}\n";
	      }
	      str += indent+"   "+c+"_0"+t+" & "+v+"_1";
	      if ( FnType != '0' )
		  str += t;
	      str += " & "+c+"_2"+t+"\n";
	      str += indent+"\\end{array}\\right)\n";
     ...
     case '8': 
          ...
          if ( OperInfo[ i ][ OPERAND_TYPE ] != '0' ){
             ...
             if ( DirChoicesAfterShort[ OperInfo[ i ][ 2 ] ] == 'B' ){
                 str += indent+"\\left(\\begin{array}{c}\n";
                 str += indent+"   "+c+"_0 \\\\ \\whline \n";
                 str += indent+"   "+v+"_1"+t+" \\\\ \\hline \n";
                 str += indent+"   "+c+"_2\n";
		 str += indent+"\\end{array}\\right)\n";
		 str += indent+"$\n";
	     }
             if ( DirChoicesAfterShort[ OperInfo[ i ][ 2 ] ] == 'T' ){
                 str += indent+"\\left(\\begin{array}{c}\n";
                 str += indent+"   "+c+"_0 \\\\ \\hline \n";
                 str += indent+"   "+v+"_1"+t+" \\\\ \\whline \n";
                 str += indent+"   "+c+"_2\n";
		 str += indent+"\\end{array}\\right)\n";
		 str += indent+"$\n";
	     }	      
     ...
     */
     ...
     case '6': 
          ...
          if ( OperInfo[ i ][ OPERAND_TYPE ] != '0' ){
             ...
             str += "\n"+indent+"\\end{array}\\right)\n";
             str += indent+"\\leftarrow\n";
	      if ( DirChoicesBeforeShort[ OperInfo[ i ][ 2 ] ] == 'R' ){
		  str += indent+"\\left(\\begin{array}{c I c | c}\n";
	      }
	      if ( DirChoicesBeforeShort[ OperInfo[ i ][ 2 ] ] == 'L' ){
		  str += indent+"\\left(\\begin{array}{c | c I c}\n";
	      }
	      str += indent+"   "+c+"_0"+t+" & "+v+"_1";
	      if ( FnType != '0' )
     ...
     case '8': 
          ...
          if ( OperInfo[ i ][ OPERAND_TYPE ] != '0' ){
             ...
             str += indent+"\\end{array}\\right) \n";
             str += indent+"\\leftarrow\n";
             if ( DirChoicesBeforeShort[ OperInfo[ i ][ 2 ] ] == 'B' ){
                 str += indent+"\\left(\\begin{array}{c}\n";
                 str += indent+"   "+c+"_0 \\\\ \\whline \n";
                 str += indent+"   "+v+"_1"+t+" \\\\ \\hline \n";
                 str += indent+"   "+c+"_2\n";
		 ...
		 str += indent+"$\n";
             ...
             if ( DirChoicesBeforeShort[ OperInfo[ i ][ 2 ] ] == 'T' ){
                 str += indent+"\\left(\\begin{array}{c}\n";
                 str += indent+"   "+c+"_0 \\\\ \\hline \n";
                 str += indent+"   "+v+"_1"+t+" \\\\ \\whline \n";
                 str += indent+"   "+c+"_2\n";
     ...
     */
     ...
     case '4':
	     ...
	     str += indent+"   "+c+"_{TL} \& "+c+"_{TR} \\\\ \\whline \n";
   	     ...
   	     str += indent+"\\end{array}\\right) \n";
             str +=  indent+"\\leftarrow\n";
             if ( DirChoicesBeforeShort[ OperInfo[ i ][ 2 ] ] == 'BR' ){
		 str +=  indent+"\\left(\\begin{array}{c I c | c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\whline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \\hline \n";
		 str +=  indent+"   "+c+"_{20} & "+v+"_{21} & "+c+"_{22}\n";
		 str +=  indent+"\\end{array}\\right) \n";
             ...
             if ( DirChoicesBeforeShort[ OperInfo[ i ][ 2 ] ] == 'TL' ){
		 str +=  indent+"\\left(\\begin{array}{c | c I c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\hline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \\whline \n";
		 str +=  indent+"   "+c+"_{20} & "+v+"_{21} & "+c+"_{22}\n";
		 str +=  indent+"\\end{array}\\right) \n";
             ...
             if ( DirChoicesBeforeShort[ OperInfo[ i ][ 2 ] ] == 'TR' ){
		 str +=  indent+"\\left(\\begin{array}{c I c | c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\hline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \\whline \n";
		 str +=  indent+"   "+c+"_{20} & "+v+"_{21} & "+c+"_{22}\n";
		 str +=  indent+"\\end{array}\\right) \n";
             ...
             if ( DirChoicesBeforeShort[ OperInfo[ i ][ 2 ] ] == 'BL' ){
		 str +=  indent+"\\left(\\begin{array}{c | c I c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\whline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \\hline \n";
		 str +=  indent+"   "+c+"_{20} & "+v+"_{21} & "+c+"_{22}\n";
...
function LAfterRepartition( FnName, FnType, Variant, NumOpers, OperInfo ){
  ...
  str += "% Step 6: State before update\n" 
  str += "% Note: The below needs editing consistent with loop-invariant!!!\n\n"
...
function LUpdate( FnName, FnType, Variant, NumOpers, OperInfo ){
  ...
  str += indent+"\\begin{array}{l}          % do not delete this line \n";
  str += indent+indent+"\\mbox{update line 1} \\\\ % replace \\mbox{...} with update line but leave \\\\  \n";
  str += indent+indent+"\\mbox{     :       } \\\\ % replace \\mbox{...} with update line but leave \\\\ \n";
  str += indent+indent+"\\mbox{update line n}    % replace \\mbox{...} with update line \n";
  str += indent+"\\end{array}               % do not delete this line \n";

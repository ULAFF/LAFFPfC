  ...
  for (i=0; i<NumOpers; i++ ){
   if ( OperInfo[ i ][ OPERAND_IO ] == IO_INOUT ){
     ...
     case '4':
	     ...
	     str += indent+"   "+c+"_{TL} \& "+c+"_{TR} \\\\ \\hline \n";
             str += indent+"   "+c+"_{BL} \& "+c+"_{BR}\n";
   	     str += indent+"\\end{array}\\right) =\n";
             str += indent+"\\left(\\begin{array}{c I c}\n";
	     str += indent+"   \\widehat "+c+"_{TL} & \\widehat "+c+"_{TR} \\\\ \\hline\n";
	 ...
	 str += indent+"\\left(\\begin{array}{c}\n";
         str += indent+"   "+c+"_T \\\\ \\hline\n";
         str += indent+"   "+c+"_B \n"
         str += indent+"\\end{array}\\right)  = \n";
	 str += indent+"\\left(\\begin{array}{c}\n";
         str += indent+"   \\widehat "+c+"_T \\\\ \\hline \n";
   ...
   for ( j=0; j<1; j++ ){
	 ...
	 */
     ...
     case '4':
		 ...
		 str +=  indent+"\\left(\\begin{array}{c | c c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \\hline \n";
		 str +=  indent+"   "+v+"_{10}"+t+" & "+s+"_{11} & "+v+"_{12}"+t+" \\\\ \n";
		 ...
		 str +=  indent+"\\left(\\begin{array}{c c | c}\n";
		 str +=  indent+"   "+c+"_{00} & "+v+"_{01} & "+c+"_{02} \\\\ \n";

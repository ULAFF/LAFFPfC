...
\renewcommand{\operation}{ A := \mbox{\sc LU\_unb\_var1}( A ) }
...
\renewcommand{\invariant}{
	...
	\left(\begin{array}{c I c}
		...
		\widehat A_{BL} & \widehat A_{BR}
	\end{array}\right) \wedge L_{TL} U_{TL} = \widehat A_{TL}
}
...
\renewcommand{\beforeupdate}{$
		...
		\widehat a_{10}^T & \widehat \alpha_{11} & \widehat a_{12}^T \\ 
		\widehat A_{20} & \widehat a_{21} & \widehat A_{22}
		\end{array}\right) \wedge L_{00} U_{00} = \widehat A_{00}
	 $}
